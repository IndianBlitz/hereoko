...
declare namespace H.map.provider.ImageTileProvider {
  type Options = { crossOrigin ? : string | null , engineType ? : H.Map.EngineType , getCopyrights ? : (a : H.geo.Rect , b : number ) => any , getURL : (a : number , b : number , c : number ) => string | undefined , headers ? : GlobalObject , max ? : number , min ? : number , opacity ? : number , tileSize ? : number , uri ? : string } ;
}
declare namespace H.map.provider {
  /**
